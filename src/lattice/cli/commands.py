...
from lattice.cli.orchestrator_commands import (  # noqa: E402
    orchestrator_init,
    orchestrator_start,
    orchestrator_voice,
    orchestrator_text,
    orchestrator_status,
    orchestrator_install_hooks,
    orchestrator_uninstall_hooks,
    orchestrator_check_hooks,
)

cli.add_command(orchestrator_init)
cli.add_command(orchestrator_start)
cli.add_command(orchestrator_voice)
cli.add_command(orchestrator_text)
cli.add_command(orchestrator_status)
cli.add_command(orchestrator_install_hooks)
...
# Legacy orchestrator commands removed — replaced by orchestrator_commands.py integration
